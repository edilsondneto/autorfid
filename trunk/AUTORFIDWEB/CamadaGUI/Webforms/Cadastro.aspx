...
<script type="text/javascript" src="../Content/Mascaras.js"></script>
    ...
    <div class="principal">  
        <div class="cad">           
            <table>
                <tr>
                    <td><asp:Label ID="lblPesFis" runat="server" Text="Pessoa Física:"></asp:Label>
                    <asp:RadioButton ID="rbtPesFis" runat="server" GroupName="rdtPessoa" 
                            oncheckedchanged="rbtPesFis_CheckedChanged" AutoPostBack="true" /></td>
                    <td><asp:Label ID="lblPesJur" runat="server" Text="Pessoa Jurídica:"></asp:Label>
                        <asp:RadioButton ID="rbtPesJur" runat="server" GroupName="rdtPessoa" 
                            oncheckedchanged="rbtPesJur_CheckedChanged" AutoPostBack="true" />
           
                    </td>
                </tr>
                <tr>
                    <td><asp:Label ID="lblRazaoSocial" runat="server" Text="Razão Social:"></asp:Label></td>
                    <td><asp:TextBox ID="txtRazaoSocial" runat="server" Width="200px" Height="13px" 
                            MaxLength="60" Enabled="False">------------</asp:TextBox></td> 
                </tr>
                <tr>
                    <td><asp:Label ID="lblCnpj" runat="server" Text="Cnpj:"></asp:Label></td>
                    <td><asp:TextBox ID="txtCnpj" runat="server" Width="150px" Height="13px" 
                            TextMode="SingleLine" onkeyup="formataCNPJ(this, event)" Enabled="False" MaxLength="18">------------</asp:TextBox>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtNome" runat="server" Width="200px" Height="13px" MaxLength="60"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtCpf" runat="server" Width="150px" Height="13px" onkeyup="formataCPF(this, event)" MaxLength="14"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtEndereco" runat="server" Width="200px" Height="13px" MaxLength="60"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtNumero" runat="server" Width="50px" Height="13px" MaxLength="20"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtBairro" runat="server" Width="100px" Height="13px" MaxLength="60"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtEmail" runat="server" Width="150px" Height="13px" MaxLength="30"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtFone" runat="server" Width="100px" Height="13px" onkeyup="formataTelefone(this, event)" Rows="14"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtCelular" runat="server" Width="100px" Height="13px" onkeyup="formataTelefone(this, event)" Rows="14"></asp:TextBox>
