...
namespace Testes
{
    ...
    public class FachadaAssociadoTest
    {
        ...
        public void InserirAssociadoTest()
        {
            ...
            Associado entAssociado = Fachada_Accessor.ObterFachada().ConsultarAssociado(associado.Idassociado);
        ...
        public void ExcluirAssociadoTest()
        {
            ...
            Associado associado = Fachada_Accessor.ObterFachada().ConsultarAssociado(this.associado.Idassociado);
