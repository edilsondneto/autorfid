...
public partial class Bancos_BancodoBrasil : System.Web.UI.Page
{
    ...
    {
        double val = Double.Parse(Session["valor"].ToString());
        ...
        Boleto b = new Boleto(vencimento, val, "16", "09876543210", c);
        ...
        b.Sacado = new Sacado("000.000.000-00", user);
        ...
        bb.Boleto = b;
        bb.Boleto.Valida();
        bb.MostrarComprovanteEntrega = (Request.Url.Query == "?show");
