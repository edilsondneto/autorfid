    ...
    public class RepositorioEstabelecimento : IEstabelecimento
    {
        ...
        public void IncluirEstabelecimento(Estabelecimento objEstabelecimento)
        {
            try
            {
                ...
                this.c.Command().Parameters.Add("@razaosocial", MySqlDbType.VarChar, 11).Value = objEstabelecimento.Razaosocial;
                ...
                this.c.Command().Parameters.Add("@email", MySqlDbType.VarChar, 40).Value = objEstabelecimento.Email;
                ...
                this.c.Command().Parameters.Add("@qtdvagasdisponiveis", MySqlDbType.Int32).Value = objEstabelecimento.Qtdvagasdisponiveis;
                this.c.Comitar();
            }
            catch (Exception e)
            {
